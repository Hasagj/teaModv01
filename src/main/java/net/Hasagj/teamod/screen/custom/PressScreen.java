...
public class PressScreen extends AbstractContainerScreen<PressMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID,"textures/gui/press/press_gui.png");
    private static final ResourceLocation ARROW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID,"textures/gui/arrow_progress.png");
    ...
    private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
        if(menu.isCrafting()) {
            guiGraphics.blit(RenderType.GUI_TEXTURED, ARROW_TEXTURE,x + 93, y + 35, 0, 0, menu.getScaledArrowProgress(), 16, 24, 16);
        }
    }
