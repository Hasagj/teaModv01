...
public class CreakingTrigger extends SimpleCriterionTrigger<CreakingTrigger.TriggerInstance> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID, "creaking_trigger");
