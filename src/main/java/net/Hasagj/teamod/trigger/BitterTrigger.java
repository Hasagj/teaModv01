...
public class BitterTrigger extends SimpleCriterionTrigger<BitterTrigger.TriggerInstance>{
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID, "bitter_trigger");

    // В ваниле SimpleCriterionTrigger требует реализации codec()
    @Override
    public Codec<BitterTrigger.TriggerInstance> codec() {
        return BitterTrigger.TriggerInstance.CODEC;
    }
    ...
    public static record TriggerInstance(
        ...
        public static final Codec<BitterTrigger.TriggerInstance> CODEC = RecordCodecBuilder.create(instance ->
                instance.group(
                        EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(BitterTrigger.TriggerInstance::playerPredicate)
                ).apply(instance, BitterTrigger.TriggerInstance::new)
        );
