...
public class SweetTrigger extends SimpleCriterionTrigger<SweetTrigger.TriggerInstance> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID, "sweet_trigger");
