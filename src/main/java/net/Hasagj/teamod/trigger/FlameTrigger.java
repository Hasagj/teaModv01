...
public class FlameTrigger extends SimpleCriterionTrigger<FlameTrigger.TriggerInstance> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID, "flame_trigger");
