...
public class AppetiteTrigger extends SimpleCriterionTrigger<AppetiteTrigger.TriggerInstance> {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TeaMod.MOD_ID, "appetite_trigger");
